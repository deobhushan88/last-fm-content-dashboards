...
def queries_networkanalysis():
	# Connecting to MySQL Database and initializing cursor
        cnx = mysql.connector.connect(user='root', password='mysql', database='273project')
        cursor = cnx.cursor()

	# Queries for network analysis
	query1 = 'SELECT * FROM topartists_1k LIMIT 10'
	query2 = 'SELECT * FROM topartists_1k2005 LIMIT 10'
	query3 = 'SELECT * FROM topartists_1k2006 LIMIT 10'
	query4 = 'SELECT * FROM topartists_1k2007 LIMIT 10'
	query5 = 'SELECT * FROM topartists_1k2008 LIMIT 10'
	query6 = 'SELECT * FROM topartists_1k2009 LIMIT 10'
	query7 = 'SELECT * FROM month_1k'
	query8 = 'SELECT * FROM day_1k'
	query9 = 'SELECT * FROM hour_1k'
	query10 = 'SELECT * FROM topartistcount_360k LIMIT 10'
	query11 = 'SELECT * FROM topartistplays_360k LIMIT 10'

	# Running queries and preparing returnDict
	returnDict = {}
	returnDict["topartists_1k"] = []
	returnDict["topartists_1k2005"] = []
	returnDict["topartists_1k2006"] = []
	returnDict["topartists_1k2007"] = []
	returnDict["topartists_1k2008"] = []
	returnDict["topartists_1k2009"] = []
	returnDict["month_1k"] = OrderedDict({})
	returnDict["day_1k"] = OrderedDict({})
	returnDict["hour_1k"] = OrderedDict({})
	returnDict["topartistcount_360k"] = []
	returnDict["topartistplays_360k"] = []

	cursor.execute(query1)
	for field,counter in cursor:
		returnDict["topartists_1k"].append(field.encode('utf-8'))

	cursor.execute(query2)
	for field,counter in cursor:
                returnDict["topartists_1k2005"].append(field.encode('utf-8'))

	cursor.execute(query3)
        for field,counter in cursor:
                returnDict["topartists_1k2006"].append(field.encode('utf-8'))

	cursor.execute(query4)
        for field,counter in cursor:
                returnDict["topartists_1k2007"].append(field.encode('utf-8'))

	cursor.execute(query5)
        for field,counter in cursor:
                returnDict["topartists_1k2008"].append(field.encode('utf-8'))

	cursor.execute(query6)
        for field,counter in cursor:
                returnDict["topartists_1k2009"].append(field.encode('utf-8'))

	cursor.execute(query7)
        for field,counter in cursor:
                returnDict["month_1k"][int(field)] = counter

	cursor.execute(query8)
        for field,counter in cursor:
                returnDict["day_1k"][int(field)] = counter

	cursor.execute(query9)
        for field,counter in cursor:
                returnDict["hour_1k"][int(field)] = counter

	cursor.execute(query10)
        for field,counter in cursor:
                returnDict["topartistcount_360k"].append(field.encode('utf-8'))
		
	cursor.execute(query11)
        for field,counter in cursor:
                returnDict["topartistplays_360k"].append(field.encode('utf-8'))
